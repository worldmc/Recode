...
<?php echo Config::get('URL')?>
    ...
    <script src="<?php echo Config::get('URL')?>js/jquery.dataTables.min.js"></script>
        ...
        <ul class="app-bar-menu">
            <li>
                ...
                <ul class="d-menu" data-role="dropdown">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?php echo Config::get('URL')?>admin/$appID">$appName</a></li>
                    <li><a href="<?php echo Config::get('URL')?>admin/$appID">$appName</a></li>
                    <li><a href="<?php echo Config::get('URL')?>admin/$appID">$appName</a></li>
                    <li><a href="<?php echo Config::get('URL')?>admin/$appID">$appName</a></li>
                    <li><a href="<?php echo Config::get('URL')?>admin/$appID">$appName</a></li>
                    <li class="divider"></li>
                    <li><a href="">Delete app</a></li>
                </ul>
            </li>
            <li><a href="<?php echo Config::get('URL')?>app">Dashboard</a></li>
        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                <div class="cell size-x200" id="cell-sidebar" style="background-color: #71b1d1; height: 100%">
                    <ul class="sidebar">
                        <li><a href="<?php echo Config::get('URL')?>admin/users">
                            <span class="mif-apps icon"></span>
                            <span class="title">Users</span>
                            <span class="counter">0</span>
                        </a></li>
                        <li><a href="<?php echo Config::get('URL')?>admin/apps">
                            <span class="mif-vpn-publ icon"></span>
                            <span class="title">Apps</span>
                            <span class="counter">0</span>
                        </a></li>
                        <li class="active"><a href="<?php echo Config::get('URL')?>admin/servers">
                            <span class="mif-drive-eta icon"></span>
                            <span class="title">Servers</span>
                            <span class="counter">2</span>
                        </a></li>
                        <li><a href="<?php echo Config::get('URL')?>admin/">
                            <span class="mif-cloud icon"></span>
                            <span class="title"></span>
                            <span class="counter">0</span>
                        </a></li>
                        <li><a href="<?php echo Config::get('URL')?>admin/DB">
                            <span class="mif-database icon"></span>
                            <span class="title">SQL Databases</span>
                            <span class="counter">1</span>
                        </a></li>
                        <li><a href="<?php echo Config::get('URL')?>admin/bot">
